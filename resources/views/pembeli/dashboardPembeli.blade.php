...
<div class="w3-content w3-padding" style="max-width:1564px">
    ...
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Our Team</h3>      
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="cdn/imgg/sonia.png" alt="Sonia" style="width:100%">
        <h3>Sonia Frisca Putri Ardana</h3>
        <p class="w3-opacity">1202200221</p>
        <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
      </div>
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="cdn/imgg/ais.png" alt="Ais" style="width:100%">
        <h3>Aisyah Wulan Aydila</h3>
        <p class="w3-opacity">1202204044</p>
        <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
      </div>
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="cdn/imgg/almira.png" alt="Almira" style="width:100%">
        <h3>Almira Syamsi Nur Insan</h3>
        <p class="w3-opacity">1202200164</p>
        <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
      </div>
      <div class="w3-col l3 m6 w3-margin-bottom">
        <img src="cdn/imgg/rehan.png" alt="Dan" style="width:100%">
        <h3>Achmad Fahresya Rayhannur</h3>
        <p class="w3-opacity">1202204161</p>
        <p><button class="w3-button w3-light-grey w3-block">Contact</button></p>
      </div>
    </div>
