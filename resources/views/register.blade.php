...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="col-md-8">
                <h1 class="text-center text-success" style="margin-top: 60px; margin-bottom: 60px;">Registrasi</h1>
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="inputAlamat" placeholder="Masukan Alamat Anda">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success" style="margin-bottom: 60px">Confirm</button>
